...
import 'package:flutter_demo_collect/Food_App/model/ingredients.dart';
...
class FoodAppHomePage extends StatefulWidget {
  ...
  const FoodAppHomePage({super.key, required this.recipeItems});
...
class MyClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    var path = Path();
    print('我是sizewidth:${size.width}');
    print('我是sizeheight:${size.height}');
